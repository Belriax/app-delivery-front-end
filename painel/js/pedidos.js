    ...
    if(lista.length > 0) {
      ...
      lista.forEach((e, i) => {
        ...
        if (e.idpedidostatus == 1){
          titleBtn = 'Pendente';
          acoes = `
            <a href="#!" class="dropdown-item" onclick="pedido.method.moverPara(2, '${e.idpedido}')">Mover para <b>Aceito</b> <i class="far fa-thumbs-up"></i></a>
            <a href="#!" class="dropdown-item" onclick="pedido.method.moverPara(3, '${e.idpedido}')">Mover para <b>Em preparo</b> <i class="far fa-clock"></i></a>
            <a href="#!" class="dropdown-item" onclick="pedido.method.moverPara(4, '${e.idpedido}')">Mover para <b>Em entrega</b> <i class="fas fa-motorcycle"></i></a>
            <a href="#!" class="dropdown-item" onclick="pedido.method.moverPara(5, '${e.idpedido}')">Mover para <b>Concluído</b> <i class="far fa-check-circle"></i></a>
            <a href="#!" class="dropdown-item" onclick="pedido.method.moverPara(6, '${e.idpedido}')">Recusar Pedido<i class="far fa-times-circle"></i></a>
          `
