...
empresa.method = {
  ...
  removeLogo: () => {
    ...
    (response) => {
      ...
      // remove o valor no localstorage
      app.method.removersecao('Logo');
  ...
  // abri a modal de adicionar logo
  openModalLogo: () => {
    MODAL_UPLOAD.show();
  },
  ...
  // adcionar uma nova linha de horário
  adicionarHorario: () => {

    let adicionar = true;

    // primeiro valida se tem alguma linha de registros;
...
empresa.template = {
  ...
  horario: `
    ...
    <div class="col-2">
      <div class="form-group">
        <p class="title-categoria mb-0"><b>Ate *:</b></p>
